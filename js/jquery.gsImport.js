        ...
        return this.append(function gsImporter() {
            ...
            function picturizeItem(nStr) {
                ...
                for (var i = map.size - 1; i >= 0; i--) {
                    var thisMapIter = mapIter.next().value;
                    if (nStr === thisMapIter[0]) {
                        return thisMapIter[1];
                    }
                ...
                case "":
                    return "-";
                case settings.picturize.image1[0]:
                    return settings.picturize.image1[1];
                case settings.picturize.image2[0]:
                    return settings.picturize.image2[1];
                default:
                    return nStr;
                }
            }
